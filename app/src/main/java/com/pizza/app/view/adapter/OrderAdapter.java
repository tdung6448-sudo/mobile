...
import com.pizza.app.databinding.ItemOrderBinding;
...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.VH> {
    ...
    public OrderAdapter(OnOrderClick listener) { this.listener = listener; }
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new VH(ItemOrderBinding.inflate(
    ...
    static class VH extends RecyclerView.ViewHolder {
        ...
        void bind(Order o) {
            ...
            binding.tvStatus.setTextColor(statusColor(o.getStatus()));
